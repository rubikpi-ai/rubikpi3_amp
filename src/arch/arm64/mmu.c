...
static void create_mmio_mapping(void)
{
	...
	__create_pgd_mapping((pgd_t *)idmap_pg_dir, 0x17B40000UL, 0x17B40000UL,
			0x20000, PROT_DEVICE_nGnRnE,
			early_pgtable_alloc,
			0);

	__create_pgd_mapping((pgd_t *)idmap_pg_dir, 0x17A60000ULL, 0x17A60000ULL,
			0x20000*8, PROT_DEVICE_nGnRnE,
			early_pgtable_alloc,
			0);

	__create_pgd_mapping((pgd_t *)idmap_pg_dir, 0x17C20000UL, 0x17C20000ULL,
			0x10000, PROT_DEVICE_nGnRnE,
			early_pgtable_alloc,
			0);

	__create_pgd_mapping((pgd_t *)idmap_pg_dir, 0x17A00000UL, 0x17A00000ULL,
			0x10000, PROT_DEVICE_nGnRnE,
			early_pgtable_alloc,
			0);
	...
	__create_pgd_mapping((pgd_t *)idmap_pg_dir, 0x00100000UL, 0x00100000ULL,
			0x1f0000, PROT_DEVICE_nGnRnE,
			early_pgtable_alloc,
			0);

	__create_pgd_mapping((pgd_t *)idmap_pg_dir, 0x009c0000UL, 0x009c0000ULL,
			0x2000, PROT_DEVICE_nGnRnE,
			early_pgtable_alloc,
			0);

	__create_pgd_mapping((pgd_t *)idmap_pg_dir, 0x00984000UL, 0x00984000ULL,
			0x4000, PROT_DEVICE_nGnRnE,
			early_pgtable_alloc,
			0);
}
